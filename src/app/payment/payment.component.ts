...
import { SpecialEventServiceService } from '../Special/special-event-service.service';
;
...
export class PaymentComponent implements OnInit{
  ...
  constructor(private eventService : SpecialEventServiceService,private activatedRoute: ActivatedRoute, private ngZone: NgZone, private router: Router) {
